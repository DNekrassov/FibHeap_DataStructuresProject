...
public class Test {
	...
	static void test16() {
		...
		if (fibonacciHeap.potential() != 3 || FibonacciHeap.totalCuts() - cuts != 0
				|| FibonacciHeap.totalLinks() - links != 0 || fibonacciHeap.countersRep()[0] != 3)
			bugFound(test);
	}
	...
	static void test17() {
		...
		if (fibonacciHeap.potential() != 1 || FibonacciHeap.totalCuts() - cuts != 0
				|| FibonacciHeap.totalLinks() - links != 1 || fibonacciHeap.countersRep()[0] != 0
	...
	static void test18() {
		...
		if (fibonacciHeap.potential() != 1 || FibonacciHeap.totalCuts() - cuts != 0
				|| FibonacciHeap.totalLinks() - links != 3 || fibonacciHeap.countersRep()[0] != 0
				|| fibonacciHeap.countersRep()[1] != 0 || fibonacciHeap.countersRep()[2] != 1)
			bugFound(test);
	}
	...
	static void test19() {
		...
		if (fibonacciHeap.potential() != 4 || FibonacciHeap.totalCuts() - cuts != 1
	...
	static void test22() {
		...
		if (fibonacciHeap.potential() != treeSize || FibonacciHeap.totalCuts() - totalCuts != treeSize - 1
				|| FibonacciHeap.totalLinks() - links != 0 || fibonacciHeap.countersRep()[0] != treeSize || noCascading)
			bugFound(test);
	}
	...
	static void test23() {
		...
		if (fibonacciHeap.potential() != size || FibonacciHeap.totalCuts() - totalCuts != 0
				|| FibonacciHeap.totalLinks() - links != 0)
			bugFound(test);
	}
	...
	static void test26() {
		...
		if (fibonacciHeap.potential() > 100 || FibonacciHeap.totalCuts() - totalCuts != 0
